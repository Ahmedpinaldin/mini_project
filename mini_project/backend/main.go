...
import (
	...
	"mini-project/Config"
	"mini-project/Handlers/AnswearHandlers"
...
func main() {
	...
	// route untuk create answer
	router.POST("/api/v1/answer", AnswearHandlers.CreateAnswerHandlerByUser(db))

	//// route untuk memberi nilai
	//router.PUT("/api/v1/answer/:id", AnswearHandlers.UpdateAnswerHandlerByAdmin(db))
